"use client"
import HiddenPostsComponent from "@/Components/ProfilePageComponents/HiddenPosts"
...
const UserPosts = () => {
    ...
    return (
        <>
            <HiddenPostsComponent userid={userid} Userposts={HiddenPostsData} UserProfile={UserProfile} />
        </>
    )
}
