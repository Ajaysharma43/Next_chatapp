...
import OptionsDrawer from "./Dialogs/OptionsDrawer";
...
const HiddenPostsComponent = ({ userid, Userposts, UserProfile }) => {
    ...
    return (
        <>
            ...
            <OptionsDrawer open={OptionsDrawerstate} onClose={HandleOptionsDrawer} dispatch={dispatch} imageid={imageid} userid={userid} imageurl={imageUrl} isHidden={IsPostHidden}/>
        </>
    );
};

export default HiddenPostsComponent;
